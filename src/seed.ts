...
export const seed = async () => {
  ...
  const maskRepo = AppDataSource.getRepository(Mask);
  const pharmacyMaskRepo = AppDataSource.getRepository(PharmacyMask);
  const openingHourRepo = AppDataSource.getRepository(PharmacyOpeningHour);
